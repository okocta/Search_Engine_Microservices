...
import com.example.assignment2w4.TextFile;
...
public class WorkerCrawler {
    ...
    private void generateReport() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("index_report_worker4.txt"))) {
            ...
            System.out.println("📄 Indexing report generated: index_report_worker4.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
