package com.example.assignment2w5;

import com.example.assignment2w5.TextFile;
...
public class WorkerCrawler {
    ...
    private void generateReport() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("index_report_worker5.txt"))) {
            ...
            System.out.println("📄 Indexing report generated: index_report_worker5.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
